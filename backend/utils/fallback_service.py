...
class FallbackService:
    ...
    def __init__(self):
        ...
        self.tool_map: Dict[str, Callable] = {
            ...
            # Prompt injection violations (comprehensive protection)
            "prompt_injection_comprehensive": jailbreak_fallback_tool,
            "ignore_instructions_attack": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_IgnoreInstructionsAttack": jailbreak_fallback_tool,
            "role_reversal_attack": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_RoleReversalAttack": jailbreak_fallback_tool,
            "chain_of_thought_extraction": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_ChainOfThoughtExtraction": jailbreak_fallback_tool,
            "base64_encoding_attack": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_Base64EncodingAttack": jailbreak_fallback_tool,
            "unicode_whitespace_abuse": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_UnicodeWhitespaceAbuse": jailbreak_fallback_tool,
            "nested_escapes_attack": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_NestedEscapesAttack": jailbreak_fallback_tool,
            "dan_style_attack": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_DANStyleAttack": jailbreak_fallback_tool,
            "evil_twin_roleplay": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_EvilTwinRoleplay": jailbreak_fallback_tool,
            "instruction_piggybacking": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_InstructionPiggybacking": jailbreak_fallback_tool,
            "context_length_attack": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_ContextLengthAttack": jailbreak_fallback_tool,
            "covert_channels": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_CovertChannels": jailbreak_fallback_tool,
            "out_of_band_exfil": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_OutOfBandExfil": jailbreak_fallback_tool,
            "template_injection": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_TemplateInjection": jailbreak_fallback_tool,
            "safety_filter_framing": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_SafetyFilterFraming": jailbreak_fallback_tool,
            "recursive_delegation": jailbreak_fallback_tool,
            "prompt_injection_comprehensive_RecursiveDelegation": jailbreak_fallback_tool,
        }
